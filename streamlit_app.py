...
st.header("Overview:")
st.write("In this analysis the following question was explored: What factors influence CO2 emmisions of cars?")
...
st.plotly_chart(fig)
st.write ("The above graph shows six makes of cars in order of their average CO2 emissions per kilometer, and the colors of the columns represent the price range. The first two makes (going left to right), Smart and Honda, emit the least carbon per kilometer out of the 42 makes in the data set, and are also the lowest in price of these six. The second two makes, Audi and BMW, emit a medium amount of CO2 per kilometre as they are found in the exact middle of the emissions ranking, they are also in the medium price range. Lamborghini and Bugatti emit the most of the 42 makes on average, and are also very high in price. This data proves our hypothesis, which was that the average carbon emissions of gasoline cars per kilometre increase with the price of the car."
)
...
st.write("Looking at the graph, it shows the 10 highest producing car makes of CO2 emission and the engine sizes. The average engine size of the 10 highest producing car makes is positively related to the CO2 emissions.")
...
st.write("Looking at the graph, it shows the 10 lowest producing car makes of CO2 emission and the engine sizes. The average engine size of the 10 highest producing car makes is positively related to the CO2 emissions.")
